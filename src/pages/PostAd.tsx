  ...
  const submitAd = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: t('Xayeysiiskaagu wuu la diray maaraynta', 'Your ad has been submitted for review')
      });
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="boost" className="text-sm">
                      🚀 {t('Boost Xayeysiiska ($5)', 'Boost Ad ($5)')} - {t('Kor u qaad xayeysiiskaaga', 'Promote your ad')}
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="highlight" className="text-sm">
                      ⭐ {t('Boost + Highlight ($10)', 'Boost + Highlight ($10)')} - {t('Ka dhig mid muuqda', 'Make it stand out')}
                    </Label>
                  </div>
                </div>
              </div>
